...
public class SettingsController {
    ...
    @FXML
    private ImageView ballImageView, paddleImageView, soundToggleImage;
    @FXML
    private ImageView leftBallImageView, rightBallImageView, leftPaddleImageView, rightPaddleImageView;
    @FXML
    private ImageView saveImageView, confirmBallImageView, confirmPaddleImageView;
    private int ballIndex = 0, paddleIndex = 0;

    public void setOpenedFromPause(boolean v) {
        openedFromPause = v;
    }
    ...
    private int find(String[] a, String v) {
    ...
    private void toggleSound(ActionEvent e) {
        ...
        if (en) SoundManager.playMenuMusic();
        else SoundManager.stopMenuMusic();
        updateSoundIcon();
        volumeSlider.setDisable(!en);
    }
    ...
    private void updateBall() {
        ballImageView.setImage(new Image(get(ballSkins[ballIndex])));
    }

    private void updatePaddle() {
        paddleImageView.setImage(new Image(get(paddleSkins[paddleIndex])));
    }
    ...
    @FXML
    private void onButtonMouseEntered(MouseEvent e) {
        Button b = (Button) e.getSource();
        switch (b.getId()) {
            case "saveButton" -> saveImageView.setImage(new Image(get("/game/arkanoid/images/save c.png")));
            case "confirmBallButton" ->
                    confirmBallImageView.setImage(new Image(get("/game/arkanoid/images/change c.png")));
            case "confirmPaddleButton" ->
                    confirmPaddleImageView.setImage(new Image(get("/game/arkanoid/images/change c.png")));
            ...
            case "rightPaddleButton" ->
                    rightPaddleImageView.setImage(new Image(get("/game/arkanoid/images/right c.png")));
        }
    }

    @FXML
    private void onButtonMouseExited(MouseEvent e) {
        Button b = (Button) e.getSource();
        switch (b.getId()) {
            case "saveButton" -> saveImageView.setImage(new Image(get("/game/arkanoid/images/save.png")));
            case "confirmBallButton" ->
                    confirmBallImageView.setImage(new Image(get("/game/arkanoid/images/change.png")));
            case "confirmPaddleButton" ->
                    confirmPaddleImageView.setImage(new Image(get("/game/arkanoid/images/change.png")));
            ...
            case "rightPaddleButton" ->
                    rightPaddleImageView.setImage(new Image(get("/game/arkanoid/images/right.png")));
        }
    }
